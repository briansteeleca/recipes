...
Sapper is a Next.js-style framework ([more on that here](recipes/how-is-sapper-different-from-next)) built around Svelte. It makes it embarrassingly easy to create extremely high performance web apps. Out of the box, you get:
